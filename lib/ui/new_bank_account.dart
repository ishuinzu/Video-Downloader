...
class NewBankAccountScreen extends StatefulWidget {
  const NewBankAccountScreen({Key? key}) : super(key: key);

  @override
  _NewBankAccountScreenState createState() => _NewBankAccountScreenState();
}

class _NewBankAccountScreenState extends State<NewBankAccountScreen> {
  ...
  void insertBankAccountInDatabase() async {
    ...
    if (bankname.isEmpty) {
      ...
      bankAccount.id = 9999999999; // Null ID
      ...
      bankAccount = await databaseHelper.insertBankAccount(bankAccount);
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
