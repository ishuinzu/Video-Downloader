...
class UpdateSocialProfileScreen extends StatefulWidget {
  const UpdateSocialProfileScreen({Key? key, required this.socialProfile}) : super(key: key);
  final SocialProfile socialProfile;

  @override
  _UpdateSocialProfileScreenState createState() => _UpdateSocialProfileScreenState();
}

class _UpdateSocialProfileScreenState extends State<UpdateSocialProfileScreen> {
  ...
  void insertSocialProfileInDatabase() async {
    ...
    if (username.isEmpty) {
      ...
      socialProfile.id = widget.socialProfile.id;
      ...
      int effected_rows = await databaseHelper.updateSocialProfile(socialProfile);

      if (effected_rows > 0) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text("Social Profile Updated"),
        ));
      }
    }
  }
  ...
  void initState() {
    ...
    _socialProfileType = widget.socialProfile.type;
    _usernameController.text = widget.socialProfile.username;
    _emailidController.text = widget.socialProfile.emailid;
    _passwordController.text = widget.socialProfile.password;
    _profilelinkController.text = widget.socialProfile.profilelink;
  }
