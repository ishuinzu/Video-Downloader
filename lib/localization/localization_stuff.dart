...
class LocalizationStuff {
  ...
  static const LocalizationsDelegate<LocalizationStuff> delegate = _DemoLocalizationsDelegate();
}

class _DemoLocalizationsDelegate extends LocalizationsDelegate<LocalizationStuff> {
  ...
  Future<LocalizationStuff> load(Locale locale) async {
    LocalizationStuff localization = LocalizationStuff(locale);
